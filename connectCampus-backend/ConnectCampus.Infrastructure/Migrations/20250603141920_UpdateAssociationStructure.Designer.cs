...
namespace ConnectCampus.Infrastructure.Migrations
{
    ...
    [Migration("20250603141920_UpdateAssociationStructure")]
    partial class UpdateAssociationStructure
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ConnectCampus.Domain.Entities.Association", b =>
                {
                    ...
                    b.PrimitiveCollection<List<Guid>>("AnnouncementIds")
                        .IsRequired()
                        .HasColumnType("uuid[]");
                    ...
                    b.PrimitiveCollection<List<Guid>>("LeadershipIds")
                        .IsRequired()
                        .HasColumnType("uuid[]");
                    ...
                    b.PrimitiveCollection<List<Guid>>("PastEventIds")
                        .IsRequired()
                        .HasColumnType("uuid[]");
                    ...
                    b.PrimitiveCollection<List<Guid>>("UpcomingEventIds")
                        .IsRequired()
                        .HasColumnType("uuid[]");
