...
namespace ConnectCampus.Application.Features.Events.Commands.CreateEvent
{
    ...
    {
        public CreateEventCommandValidator(IAssociationRepository associationRepository, IEventRepository eventRepository)
        {
            ...
            RuleFor(x => x.StartDate)
                ...
                .Must((cmd, startDate) => startDate >= DateTime.UtcNow)
