...
{
    public class GetFeaturedEventsQueryHandler : IQueryHandler<GetFeaturedEventsQuery, List<EventSummaryDto>>
    {
        ...
        public async Task<Maybe<List<EventSummaryDto>>> Handle(GetFeaturedEventsQuery request, CancellationToken cancellationToken)
        {
