...
const TwoFactorForm = ({ email, isLoading, error, onCodeSubmit, onBackToLogin, onResendCode }: TwoFactorFormProps) => {
    ...
    <form onSubmit={handleSubmit}>
      <CardContent className="space-y-4 p-6">
        ...
        <div className="flex flex-col space-y-2 pt-1">
          <Button type="button" variant="ghost" className="w-full h-9 text-xs hover:bg-muted/80 rounded-md transition-all duration-200" onClick={onResendCode} disabled={isLoading}>
            Didn't receive the code? <span className="font-semibold ml-1">Resend</span>
          </Button>
